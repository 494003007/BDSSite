...
INSERT INTO recordme.sys_permission (available, create_time, name, parent_id, parent_ids, permission, resource_type, url) VALUES (true, '2017-04-09', '角色管理', 1, '1', '', 'button', '/AuthorizationManage/roleList');
...
INSERT INTO recordme.sys_permission (available, create_time, name, parent_id, parent_ids, permission, resource_type, url) VALUES (true, '2017-04-09', '权限管理', 1, '1', '', 'button', '/AuthorizationManage/permissionList');
