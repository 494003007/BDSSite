package com.bdssite.tool.ThesaurusGenerator.professionalLexiconGenerator;
...
public class ProfessionalLexiconGneratorMain {
    ...
    public ProfessionalLexiconGneratorMain(String captureUrl) throws Exception {
        String ul = "";
        String li = "";
        String dt = "";
        String liLexicon = "";
    ...
    public static void main(String[] args) throws Exception {
        ProfessionalLexiconGneratorMain requireProfessionalLexicon = new ProfessionalLexiconGneratorMain("https://www.liepin.com");
        Iterator var2 = requireProfessionalLexicon.getList().iterator();

        while(var2.hasNext()) {
            LexiconCategories lexiconCategories = (LexiconCategories)var2.next();
            System.out.println(lexiconCategories.getId()+"\t"+lexiconCategories.getClassification()+"\t"+lexiconCategories.getDescription()+"\t"+lexiconCategories.getParentNode());
        }
