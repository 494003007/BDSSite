...
//
                String jsonStr = null;
                jsonStr = solrManager.excuteAndOutPut(user.getPushUrl());
                    //jsonStr = solrManager.excuteAndOutPut("findJob?q=java&rows=2");
                ...
                if(((String)((JSONObject)data.get(0)).get("url")).equals("findJob?wt=json&q=java&rows=2")) {
    ...
    public StringBuilder appendDiv(JSONObject object){
        ...
        html.append("</a>");
        html.append("<p class=\"sr-item-links\"><a href=\""+(String)object.get("url")+"\">Into this page</a></p>");
