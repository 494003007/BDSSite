    ...
    a.fn.smartWizard = function (m) {
        ...
        return this.each(function () {
            function C() {
                ...
                q = a("<a id='next'>" + c.labelNext + "</a>").attr("href", "#").addClass("btn btn-default pull-right");
                ...
                a(q).click(function () {
                    if (a(this).hasClass("disabled"))return !1;
                    else if ($("#nextSubmitEmail") != null && $("#nextSubmitEmail").hasClass("submitEmail")) {
                        alert($("#email").val());
                        var xmlhttp;
                        ...
                        xmlhttp.open("POST", c.nextRetrieveUrl, true);
                        xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
                        xmlhttp.send("email=" + $("#email").val());
                        alert("##########"+$("#email-error").style['display']);
                        A();

                        if ($("#email-error").style.display) {
                            $("#nextSubmitEmail").removeClass("submitEmail");
                        }
                        else{
                            $("#nextSubmitEmail").removeClass("submitEmail");
                            $("#nextSubmitEmail").addClass("submitEmail");
                        }
                        return !1
                    }
                    ;
